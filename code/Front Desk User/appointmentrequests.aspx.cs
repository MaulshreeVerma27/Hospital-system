...
namespace HospitalSystem
{
    public partial class appointmentrequests : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from Appointments where IsDeleted = 0 and IsAccepted = 0 and Istreated = 0", c.con);
        ...
        private void updaterow(int applicationid, int approval)
        {
            ...
            SqlCommand cmd1 = new SqlCommand("Update Appointments set IsAccepted='" + approval + "' , ApprovedBy='"+ Session["User"] + "' where ID=" + applicationid,c.con);
